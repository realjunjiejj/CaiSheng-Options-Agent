...
def build_long_straddle_candidate(
    ...
    legs = [
        OptionLeg(
            ...
            implied_vol=atm_call.vendor_implied_vol or 0.60,
        ...
        OptionLeg(
            ...
            implied_vol=atm_put.vendor_implied_vol or 0.60,
...
def build_short_iron_butterfly_candidate(
    ...
    legs = [
        OptionLeg(
            ...
            implied_vol=wing_put.vendor_implied_vol or 0.60,
            delta=g_lp["delta"],
            gamma=g_lp["gamma"],
            theta=g_lp["theta"],
            vega=g_lp["vega"],
        ...
        OptionLeg(
            ...
            implied_vol=wing_call.vendor_implied_vol or 0.60,
            delta=g_lc["delta"],
            gamma=g_lc["gamma"],
            theta=g_lc["theta"],
            vega=g_lc["vega"],
